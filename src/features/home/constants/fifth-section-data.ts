...
export const data: SectionData = [
  {
    ...
    imageUrl: "/images/StPaulDeVence2.png",
    description:
    ...
    links: [
      {
        text: "Le Festival de Cannes",
        link: "#",
      },
      {
        text: "Carnaval de Nice",
        link: "#",
      },
      {
        text: "Fête du Citron",
  ...
  },
  {
    ...
    imageUrl: "/images/LaRouteNationale5.png",
    description:
    ...
    links: [
      {
        text: "Grand prix de Monaco",
        link: "#",
      },
      {
        text: "Ironman France – Nice",
        link: "#",
      },
      {
        text: "Marathon des Alpes-Maritimes",
        link: "#",
      },
      {
        text: "Régates de Saint-Tropez",
        link: "#",
      },
    ],
    buttonLink: {
  ...
  },
  {
    ...
    imageUrl: "/images/FayenceTourettesSeillans22.png",
    description:
    ...
    links: [],
    buttonLink: {
      text: "Consulter la liste des meilleurs restaurants",
      link: "#",
    },
  },
  {
    ...
    imageUrl: "/images/PortGrimaudCiteLacustre33.png",
    description:
  ...
  },
  {
    ...
    imageUrl: "/images/CapDramont2.png",
    description:
    ...
    links: [
      {
        text: "Grand Canyon du Verdon",
        link: "",
      },
    ],
    buttonLink: {
      text: "Consulter la liste des sentiers pédestres",
      link: "",
    },
  },
];
